...
Create a custom named deck or use the defaults provided. Cards, decks and piles can be named and have custom metadata added for extending to display or similar
